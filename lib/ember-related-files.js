...
const CONFIG_SCHEMA = [/*'matchNumber',*/ 'search', 'searchDir', 'test'];
...
export default {
  ...
  getConfigFile() {
    let filePath = path.resolve(this.rootDirectory, this.config.pathToRegexs);
  ...
  async toggle() {
    ...
    //
    // this.parsePath(absolutePath, (data) => {
